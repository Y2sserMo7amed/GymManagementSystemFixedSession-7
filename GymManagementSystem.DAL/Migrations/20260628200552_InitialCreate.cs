    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Access to gym equipment during staffed hours", 30, true, "Basic Plan", 50m },
                    { 2, "Full access to all gym facilities", 60, true, "Standard Plan", 100m },
                    { 3, "Unlimited access plus personal trainer sessions", 90, true, "Premium Plan", 200m }
                });
